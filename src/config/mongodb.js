...
const MONGODB_URI =
  "mongodb+srv://huyminh356:TxQAsM4cwVWbYK1U@camibackend.v6rfg.mongodb.net/?retryWrites=true&w=majority&appName=CamiBackend";

const DATABASE_NAME = "Cami-database";
...
export const CONNECT_DB = async () => {
  ...
  camiDatabaseInstance = mongoClientInstance.db(DATABASE_NAME);
};
